...
def clean_data(df):
    ...
    # Use the first row to extract the column names
...
def save_data(df, database_filename):
    ...
    #print(database_filename, 'and ', database_filename[:-3])
...
def main():
    """
    Example of use:
        python process_data.py location_of_messages location_of_categories location_to_save
